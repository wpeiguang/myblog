<form id="qForm" class="form-horizontal" method="post" action="update">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-8">
            ...
            <p class="help-block">示例: http://www.wpeiguang.top</p>
        </div>
    </div>
    <div class="form-group">
	...
	<div class="form-group">
        ...
        <div class="col-lg-5">
            ...
            <p class="help-block">示例: Copyright © Mbox</p>
        </div>
    </div>
    <div class="form-group">
	...
	<div class="form-group">
        <label class="col-lg-2 control-label">广告代码</label>
        <div class="col-lg-8">
            <textarea rows="3" class="form-control" name="site_advs_right" placeholder="请输入广告代码">${configs['site_advs_right'].value}</textarea>
        </div>
    </div>
    <div class="form-group">
